    ...
    <div className="px-6 md:px-12 lg:px-24 pt-32 pb-20">
      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-20">
        <div className="w-full lg:w-2/3 space-y-5">
          <h1 className="text-4xl font-mons tracking-wide">{blog?.title}</h1>
          <p className="mt-4 text-gray-600">{blog?.description}</p>
          <div className="flex flex-col sm:flex-row justify-between py-3 border-y">
        ...
        <div className="w-full lg:w-1/3 lg:sticky h-[30vh] sm:h-[40vh] lg:h-[60vh] top-24">
          <div className="relative bg-gray-200 h-full w-full overflow-hidden">
            <img
            ...
            <Link
              href="/products"
              className="whitespace-nowrap absolute left-1/2 -translate-x-1/2 bottom-10 inline-block px-8 py-3 bg-primary text-white text-base sm:text-lg font-mons transition duration-300 hover:bg-primary-hover"
            >
