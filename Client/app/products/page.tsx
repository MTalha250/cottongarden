...
const page = () => {
  ...
  return (
    <div className="pt-32 px-6 md:px-12 lg:px-24">
      <SEO
        title="Catalogue | GYMGear"
        description="Find top-quality fitness gear designed to elevate your workouts. Explore our range of equipment, apparel, and accessories built for performance and durability. Get the tools you need to power your fitness journey!"
      />
