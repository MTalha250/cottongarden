...
const page = () => {
  ...
  return (
    <section className="pt-28 pb-16 px-6 md:px-12 lg:px-24">
      <SEO
        title="Products | Cotton Garden"
        description="Explore Cotton Garden's collection of cotton essentials for men, women, and kids. Breathable fabrics, everyday comfort, and timeless style."
      />
      <div className="text-center mb-10 md:mb-12 flex flex-col items-center">
        ...
        <p className="text-sm md:text-base mt-3 text-gray-600 max-w-2xl">
          From effortless tees to cozy knitwear, find everyday pieces crafted
          from breathable, quality cotton for the whole family.
        </p>
      </div>
