...
const page = () => {
  ...
  return (
    <div className="pt-32 px-6 md:px-12 lg:px-24">
      <SEO
        title={`${decodeURI(category.toString())} | GYMGear`}
        description={`Explore our wide range of premium gym clothing and accessories in the ${decodeURI(
          category.toString()
        )} category. Whether you need performance wear or essential gear, we've got everything to power your fitness journey.`}
      />
